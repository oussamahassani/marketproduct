...
const ElectroniqueStock = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await ProductServices.getAllProducts(0, 20, "Électronique");
  ...
  return (
    <div>
      ...
      <h2>Produits de la catégorie Électronique</h2>
...
export default ElectroniqueStock;